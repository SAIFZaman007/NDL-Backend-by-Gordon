...
class BaseLearningPath(_PrismaModel):
    __prisma_model__: ClassVar[Literal['LearningPath']] = 'LearningPath'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.LearningPathActions[_PrismaModelT]':
        from .client import get_client

        return actions.LearningPathActions[_PrismaModelT](client or get_client(), cls)


class BaseCourseOnLearningPath(_PrismaModel):
    __prisma_model__: ClassVar[Literal['CourseOnLearningPath']] = 'CourseOnLearningPath'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.CourseOnLearningPathActions[_PrismaModelT]':
        from .client import get_client

        return actions.CourseOnLearningPathActions[_PrismaModelT](client or get_client(), cls)
