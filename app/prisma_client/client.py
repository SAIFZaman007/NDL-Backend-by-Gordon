...
SCHEMA_PATH = Path('C:/Users/WIN 11/Downloads/Gordon_IT/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\WIN 11\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    learningpath: 'actions.LearningPathActions[models.LearningPath]'
    courseonlearningpath: 'actions.CourseOnLearningPathActions[models.CourseOnLearningPath]'
    ...
    def __init__(
        ...
        *,
        ...
        self.learningpath = actions.LearningPathActions[models.LearningPath](self, models.LearningPath)
        self.courseonlearningpath = actions.CourseOnLearningPathActions[models.CourseOnLearningPath](self, models.CourseOnLearningPath)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/WIN 11/Downloads/Gordon_IT/backend/prisma/schema.prisma',
        }
...
class Batch:
    ...
    learningpath: 'LearningPathBatchActions'
    courseonlearningpath: 'CourseOnLearningPathBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.learningpath = LearningPathBatchActions(self)
        self.courseonlearningpath = CourseOnLearningPathBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class LearningPathBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class CourseOnLearningPathBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
    ...
    def create(
        ...
        self._batcher._add(
            method='create',
            model=models.CourseOnLearningPath,
            arguments={
                'data': data,
                'include': include,
            },
