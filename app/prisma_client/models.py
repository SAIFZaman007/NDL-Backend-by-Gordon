...
class Course(bases.BaseCourse):
    ...
    learningPaths: Optional[List['models.CourseOnLearningPath']] = None
...
class LearningPath(bases.BaseLearningPath):
    """Represents a LearningPath record"""

    id: _str
    title: _str
    description: Optional[_str] = None
    pathType: _str
    iconUrl: Optional[_str] = None
    courses: Optional[List['models.CourseOnLearningPath']] = None
    createdAt: datetime.datetime
    updatedAt: datetime.datetime
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.LearningPathKeys']] = None,
        exclude: Optional[Iterable['types.LearningPathKeys']] = None,
        required: Optional[Iterable['types.LearningPathKeys']] = None,
        optional: Optional[Iterable['types.LearningPathKeys']] = None,
        relations: Optional[Mapping['types.LearningPathRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.LearningPathKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _LearningPath_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _LearningPath_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _LearningPath_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if exclude_relational_fields:
                fields = {
                    key: data
                    for key, data in fields.items()
                    if key not in _LearningPath_relational_fields
                }

            if relations:
                for field, type_ in relations.items():
                    if field not in _LearningPath_relational_fields:
                        raise errors.UnknownRelationalFieldError('LearningPath', field)
            ...
            raise ValueError(
                f'{exc.args[0]} is not a valid LearningPath / {name} field.'
            ) from None
        ...
        models.append(
            {
                'name': name,
                'fields': cast(Mapping[str, PartialModelField], fields),
                'from_model': 'LearningPath',
            }
        )
        _created_partial_types.add(name)


class CourseOnLearningPath(bases.BaseCourseOnLearningPath):
    """Represents a CourseOnLearningPath record"""

    id: _str
    learningPathId: _str
    courseId: _str
    orderIndex: _int
    learningPath: Optional['models.LearningPath'] = None
    course: Optional['models.Course'] = None
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.CourseOnLearningPathKeys']] = None,
        exclude: Optional[Iterable['types.CourseOnLearningPathKeys']] = None,
        required: Optional[Iterable['types.CourseOnLearningPathKeys']] = None,
        optional: Optional[Iterable['types.CourseOnLearningPathKeys']] = None,
        relations: Optional[Mapping['types.CourseOnLearningPathRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.CourseOnLearningPathKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _CourseOnLearningPath_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _CourseOnLearningPath_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _CourseOnLearningPath_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if exclude_relational_fields:
                fields = {
                    key: data
                    for key, data in fields.items()
                    if key not in _CourseOnLearningPath_relational_fields
                }

            if relations:
                for field, type_ in relations.items():
                    if field not in _CourseOnLearningPath_relational_fields:
                        raise errors.UnknownRelationalFieldError('CourseOnLearningPath', field)
            ...
            raise ValueError(
                f'{exc.args[0]} is not a valid CourseOnLearningPath / {name} field.'
            ) from None
        ...
        models.append(
            {
                'name': name,
                'fields': cast(Mapping[str, PartialModelField], fields),
                'from_model': 'CourseOnLearningPath',
            }
        )
        _created_partial_types.add(name)
...
_Course_fields: Dict['types.CourseKeys', PartialModelField] = OrderedDict(
    [
        ...
        ('learningPaths', {
            ...
            'is_list': True,
            'optional': True,
            'type': 'List[\'models.CourseOnLearningPath\']',
            'is_relational': True,
            'documentation': None,
        }),
    ],
...
_LearningPath_relational_fields: Set[str] = {
        'courses',
    }
_LearningPath_fields: Dict['types.LearningPathKeys', PartialModelField] = OrderedDict(
    [
        ('id', {
            'name': 'id',
            'is_list': False,
...
_CourseOnLearningPath_relational_fields: Set[str] = {
        'learningPath',
        'course',
    }
_CourseOnLearningPath_fields: Dict['types.CourseOnLearningPathKeys', PartialModelField] = OrderedDict(
    [
        ('id', {
            'name': 'id',
            'is_list': False,
...
model_rebuild(LearningPath)
model_rebuild(CourseOnLearningPath)
